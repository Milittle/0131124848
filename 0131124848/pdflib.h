/*---------------------------------------------------------------------------*
 |          Copyright (c) 1997-2015 PDFlib GmbH. All rights reserved.        |
 +---------------------------------------------------------------------------+
...
/* $Id: pdflib.h,v 1.418.2.41 2015/05/20 11:28:13 rjs Exp $
 *
...
#define PDFLIB_LONG_VERSIONSTRING  "9.0.5" /* full version number*/
...
*/
PDFLIB_API int PDFLIB_CALL
PDF_shading(PDF *p, const char *shtype, double x0, double y0, double x1,
...
struct PDFlib_api_s {
    ...
    void (PDFLIB_CALL * PDF_setrgbcolor_stroke)(PDF *p,
                double red, double green, double blue);
    int (PDFLIB_CALL * PDF_shading)(PDF *p, const char *shtype, double x0,
...
#pragma deprecated(PDF_set_parameter)
#pragma deprecated(PDF_set_value)
#pragma deprecated(PDF_setdash)
#pragma deprecated(PDF_setdashpattern)
#pragma deprecated(PDF_setflat)
#pragma deprecated(PDF_setgray)
#pragma deprecated(PDF_setgray_fill)
#pragma deprecated(PDF_setgray_stroke)
#pragma deprecated(PDF_setinitgraphics)
#pragma deprecated(PDF_setlinejoin)
#pragma deprecated(PDF_setlinecap)
#pragma deprecated(PDF_setmiterlimit)
...
#pragma deprecated(PDF_utf16_to_utf8)
#pragma deprecated(PDF_utf8_to_utf16)
#pragma deprecated(PDF_utf32_to_utf8)
#pragma deprecated(PDF_utf8_to_utf32)
#pragma deprecated(PDF_utf16_to_utf32)
#pragma deprecated(PDF_utf32_to_utf16)
#pragma deprecated(PDF_xshow)
